...
{
	$to = 'info@corgisncritters.org,liechtywebdesign@gmail.com';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U2893"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone Number:</b></td><td>' . htmlentities($_REQUEST["custom_U2858"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U2883"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$headers = 'From:  info@corgisncritters.org' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 5.0.704 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"confirmation.html"}}';
